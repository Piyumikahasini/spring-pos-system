...
function generateCustomerID() {
    ...
    $.ajax({
        url: "http://localhost:8080/app/customer/CustomerIdGenerate",
        method: "GET",
...
$("#btnCustomerSave").click(function () {
    ...
    $.ajax({
        url: "http://localhost:8080/app/customer", method: "post",
...
function loadAllCustomer() {
    ...
    $.ajax({
        url:  "http://localhost:8080/app/customer/loadAllCustomer", method: "GET", dataType: "json", success: function (res) {
            console.log(res);
...
$("#searchCusId").on("keypress", function (event) {
    if (event.which === 13) {
        ...
        $("#tbody-customer").empty();
        $.ajax({
            url: "http://localhost:8080/app/customer/searchCusId/?id="+ search,
            method: "GET",
            contentType: "application/json",
            dataType: "json",
            success: function (res) {
